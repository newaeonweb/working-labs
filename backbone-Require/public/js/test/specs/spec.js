...
// --------------------------
define(["jquery", "backbone", "text!templates/homeView.html", "views/homeView","models/Model", "collections/Collection", "routers/DesktopRouter", "routers/MobileRouter", "jasminejquery"],

    function($, Backbone, headerText, homeView, Model, Collection, DesktopRouter, MobileRouter) {
        ...
        describe("Backbone-Require-Boilerplate (BRB)", function() {
            ...
            describe("Backbone views", function() {
                ...
                it("should contain the correct view element", function() {
                    ...
                    expect(this.view.$el.selector).toEqual("#main-app");
